define('EcgDayRate',['Raphael','Triangle'], function (Raphael,Triangle) {
    ...
    for (var i = 1; i <= 24; i++) {
        ...
        if (i == 3) {
            paper.text(x, labelY, '3').attr({"font-size":"7"});;
        }
        if (i == 6) {
        ...
        if (i == 9) {
            paper.text(x, labelY, '9').attr({"font-size":"7"});;
        }
        if (i == 12) {
        ...
        if (i == 15) {
            paper.text(x, labelY, '15').attr({"font-size":"7"});;
        }
        if (i == 18) {
        ...
        if (i == 21) {
            paper.text(x, labelY, '21').attr({"font-size":"7"});;
        }
    }
    ...
    for (var m = 0; m < eventList.length; m++) {
        ...
        if (event.eventIndex < 5||event.eventIndex==6) {//画圆形
           ...
           if (datas){
            ...
            for (var n = 0; n < datas.length; n++) {
                var data = datas[n];
                if (data.start<=1440 && data.end<=1440){
